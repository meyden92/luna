    ...
    <section className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="space-y-8">
        ...
        <Section title="2. Information We Collect">
          <p className="mb-3">We collect several types of information from and about users of our Service, including:</p>
          <SubHeading>2.1 Personal Data</SubHeading>
          <p className="mb-3">Personal information that you provide to us, which may include:</p>
          <List
            items={[
          ...
          <p className="mb-3">Information related to the audio content you upload, create, or interact with:</p>
          <List
            items={[
          ...
          <p className="mb-3">Information about how you use our Service:</p>
          <List
            items={[
        ...
        <Section title="3. How We Collect Information">
          ...
          <p className="mb-3">We collect information directly from you when you:</p>
          <List
            items={[
          ...
          <p className="mb-3">We automatically collect certain information when you use our Service through:</p>
        ...
        <Section title="5. How We Share Your Information">
          <p className="mb-3">We may share your information with the following categories of recipients:</p>
        ...
        <Section title="11. Music and Audio Privacy Considerations">
          <p className="mb-3">As a music and audio sharing platform, we handle content that may have special privacy considerations:</p>
          <ul className="list-disc pl-6 mb-3 space-y-1">
            <li>
